...
#include "QTEPlugin/Public/UQTEUtilities.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeUQTEUtilities() {}
// Cross Module References
	QTEPLUGIN_API UEnum* Z_Construct_UEnum_QTEPlugin_KeyResultData();
	UPackage* Z_Construct_UPackage__Script_QTEPlugin();
	QTEPLUGIN_API UEnum* Z_Construct_UEnum_QTEPlugin_QTEInputPath();
	QTEPLUGIN_API UScriptStruct* Z_Construct_UScriptStruct_FSubSequenceHelper();
	INPUTCORE_API UScriptStruct* Z_Construct_UScriptStruct_FKey();
	QTEPLUGIN_API UScriptStruct* Z_Construct_UScriptStruct_FSubSequence();
	QTEPLUGIN_API UScriptStruct* Z_Construct_UScriptStruct_FPrecisionKeys();
	QTEPLUGIN_API UScriptStruct* Z_Construct_UScriptStruct_FKeyToTimeBindHelper();
	QTEPLUGIN_API UScriptStruct* Z_Construct_UScriptStruct_FKeyToTimeBinding();
	QTEPLUGIN_API UScriptStruct* Z_Construct_UScriptStruct_FKeyInfo();
	QTEPLUGIN_API UScriptStruct* Z_Construct_UScriptStruct_FInputStruct();
	QTEPLUGIN_API UScriptStruct* Z_Construct_UScriptStruct_FInputData();
	QTEPLUGIN_API UEnum* Z_Construct_UEnum_QTEPlugin_QTEConditionalInput();
	QTEPLUGIN_API UScriptStruct* Z_Construct_UScriptStruct_FConditionalQTEHelperData();
	QTEPLUGIN_API UScriptStruct* Z_Construct_UScriptStruct_FConditionalQTEHelper();
	QTEPLUGIN_API UScriptStruct* Z_Construct_UScriptStruct_FResultSequenceBinding();
	MOVIESCENE_API UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneObjectBindingID();
	QTEPLUGIN_API UScriptStruct* Z_Construct_UScriptStruct_FConditionalSequencesSupport();
	LEVELSEQUENCE_API UClass* Z_Construct_UClass_ULevelSequence_NoRegister();
	QTEPLUGIN_API UScriptStruct* Z_Construct_UScriptStruct_FConditionalSequences();
	QTEPLUGIN_API UScriptStruct* Z_Construct_UScriptStruct_FConditionalQTE();
	QTEPLUGIN_API UScriptStruct* Z_Construct_UScriptStruct_FSequenceNode();
	QTEPLUGIN_API UScriptStruct* Z_Construct_UScriptStruct_FQTEInputDataTable();
	ENGINE_API UScriptStruct* Z_Construct_UScriptStruct_FTableRowBase();
	QTEPLUGIN_API UScriptStruct* Z_Construct_UScriptStruct_FEntityDataHelper();
	QTEPLUGIN_API UScriptStruct* Z_Construct_UScriptStruct_FQTEEntitySettings();
	ENGINE_API UClass* Z_Construct_UClass_UDataTable_NoRegister();
	QTEPLUGIN_API UScriptStruct* Z_Construct_UScriptStruct_FTimeSequenceHelper();
// End Cross Module References
	...
	static UEnum* KeyResultData_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_KeyResultData.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_QTEPlugin_KeyResultData, Z_Construct_UPackage__Script_QTEPlugin(), TEXT("KeyResultData"));
		}
		return Z_Registration_Info_UEnum_KeyResultData.OuterSingleton;
	}
	template<> QTEPLUGIN_API UEnum* StaticEnum<KeyResultData>()
	{
		return KeyResultData_StaticEnum();
	}
	struct Z_Construct_UEnum_QTEPlugin_KeyResultData_Statics
	{
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_QTEPlugin_KeyResultData_Statics::Enumerators[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_QTEPlugin_KeyResultData_Statics::Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "Comment", "/**\n * \n */" },
...
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_QTEPlugin_KeyResultData_Statics::EnumParams = {
		(UObject*(*)())Z_Construct_UPackage__Script_QTEPlugin,
		nullptr,
		"KeyResultData",
		"KeyResultData",
		Z_Construct_UEnum_QTEPlugin_KeyResultData_Statics::Enumerators,
		UE_ARRAY_COUNT(Z_Construct_UEnum_QTEPlugin_KeyResultData_Statics::Enumerators),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_QTEPlugin_KeyResultData_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_QTEPlugin_KeyResultData_Statics::Enum_MetaDataParams))
	};
	UEnum* Z_Construct_UEnum_QTEPlugin_KeyResultData()
	{
		if (!Z_Registration_Info_UEnum_KeyResultData.InnerSingleton)
		{
			UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_KeyResultData.InnerSingleton, Z_Construct_UEnum_QTEPlugin_KeyResultData_Statics::EnumParams);
		}
	...
	static UEnum* QTEInputPath_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_QTEInputPath.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_QTEPlugin_QTEInputPath, Z_Construct_UPackage__Script_QTEPlugin(), TEXT("QTEInputPath"));
		}
		return Z_Registration_Info_UEnum_QTEInputPath.OuterSingleton;
	}
	template<> QTEPLUGIN_API UEnum* StaticEnum<QTEInputPath>()
	{
		return QTEInputPath_StaticEnum();
	}
	struct Z_Construct_UEnum_QTEPlugin_QTEInputPath_Statics
	{
		static const UECodeGen_Private::FEnumeratorParam Enumerators[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[];
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_QTEPlugin_QTEInputPath_Statics::Enumerators[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_QTEPlugin_QTEInputPath_Statics::Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_QTEPlugin_QTEInputPath_Statics::EnumParams = {
		(UObject*(*)())Z_Construct_UPackage__Script_QTEPlugin,
		nullptr,
		"QTEInputPath",
		"QTEInputPath",
		Z_Construct_UEnum_QTEPlugin_QTEInputPath_Statics::Enumerators,
		UE_ARRAY_COUNT(Z_Construct_UEnum_QTEPlugin_QTEInputPath_Statics::Enumerators),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_QTEPlugin_QTEInputPath_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_QTEPlugin_QTEInputPath_Statics::Enum_MetaDataParams))
	};
	UEnum* Z_Construct_UEnum_QTEPlugin_QTEInputPath()
	{
		if (!Z_Registration_Info_UEnum_QTEInputPath.InnerSingleton)
		{
			UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_QTEInputPath.InnerSingleton, Z_Construct_UEnum_QTEPlugin_QTEInputPath_Statics::EnumParams);
		}
...
class UScriptStruct* FSubSequenceHelper::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SubSequenceHelper.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSubSequenceHelper, Z_Construct_UPackage__Script_QTEPlugin(), TEXT("SubSequenceHelper"));
	}
	return Z_Registration_Info_UScriptStruct_SubSequenceHelper.OuterSingleton;
}
template<> QTEPLUGIN_API UScriptStruct* StaticStruct<FSubSequenceHelper>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSubSequenceHelper_Statics::NewProp_Keys_Inner = { "Keys", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FKey, METADATA_PARAMS(nullptr, 0) }; // 2615338182
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FSubSequenceHelper_Statics::NewProp_Keys = { "Keys", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSubSequenceHelper, Keys), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FSubSequenceHelper_Statics::NewProp_Keys_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSubSequenceHelper_Statics::NewProp_Keys_MetaData)) }; // 2615338182
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FSubSequenceHelper_Statics::NewProp_bHoldKey = { "bHoldKey", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FSubSequenceHelper), &Z_Construct_UScriptStruct_FSubSequenceHelper_Statics::NewProp_bHoldKey_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FSubSequenceHelper_Statics::NewProp_bHoldKey_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSubSequenceHelper_Statics::NewProp_bHoldKey_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSubSequenceHelper_Statics::NewProp_HoldTime = { "HoldTime", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSubSequenceHelper, HoldTime), METADATA_PARAMS(Z_Construct_UScriptStruct_FSubSequenceHelper_Statics::NewProp_HoldTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSubSequenceHelper_Statics::NewProp_HoldTime_MetaData)) };
...
class UScriptStruct* FSubSequence::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SubSequence.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSubSequence, Z_Construct_UPackage__Script_QTEPlugin(), TEXT("SubSequence"));
	}
	return Z_Registration_Info_UScriptStruct_SubSequence.OuterSingleton;
}
template<> QTEPLUGIN_API UScriptStruct* StaticStruct<FSubSequence>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSubSequence_Statics::NewProp_KeyMap_Inner = { "KeyMap", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FSubSequenceHelper, METADATA_PARAMS(nullptr, 0) }; // 3043625189
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FSubSequence_Statics::NewProp_KeyMap = { "KeyMap", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSubSequence, KeyMap), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FSubSequence_Statics::NewProp_KeyMap_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSubSequence_Statics::NewProp_KeyMap_MetaData)) }; // 3043625189
...
class UScriptStruct* FPrecisionKeys::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PrecisionKeys.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPrecisionKeys, Z_Construct_UPackage__Script_QTEPlugin(), TEXT("PrecisionKeys"));
	}
	return Z_Registration_Info_UScriptStruct_PrecisionKeys.OuterSingleton;
}
template<> QTEPLUGIN_API UScriptStruct* StaticStruct<FPrecisionKeys>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FPrecisionKeys_Statics::NewProp_Keys_Inner = { "Keys", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FKey, METADATA_PARAMS(nullptr, 0) }; // 2615338182
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FPrecisionKeys_Statics::NewProp_Keys = { "Keys", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPrecisionKeys, Keys), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FPrecisionKeys_Statics::NewProp_Keys_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPrecisionKeys_Statics::NewProp_Keys_MetaData)) }; // 2615338182
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FPrecisionKeys_Statics::NewProp_TimeLength = { "TimeLength", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPrecisionKeys, TimeLength), METADATA_PARAMS(Z_Construct_UScriptStruct_FPrecisionKeys_Statics::NewProp_TimeLength_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPrecisionKeys_Statics::NewProp_TimeLength_MetaData)) };
...
class UScriptStruct* FKeyToTimeBindHelper::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_KeyToTimeBindHelper.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FKeyToTimeBindHelper, Z_Construct_UPackage__Script_QTEPlugin(), TEXT("KeyToTimeBindHelper"));
	}
	return Z_Registration_Info_UScriptStruct_KeyToTimeBindHelper.OuterSingleton;
}
template<> QTEPLUGIN_API UScriptStruct* StaticStruct<FKeyToTimeBindHelper>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_bPrecision = { "bPrecision", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FKeyToTimeBindHelper), &Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_bPrecision_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_bPrecision_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_bPrecision_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_PreciseKeys_Inner = { "PreciseKeys", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FPrecisionKeys, METADATA_PARAMS(nullptr, 0) }; // 4206374372
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_PreciseKeys = { "PreciseKeys", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKeyToTimeBindHelper, PreciseKeys), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_PreciseKeys_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_PreciseKeys_MetaData)) }; // 4206374372
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_bHasSubSequence = { "bHasSubSequence", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FKeyToTimeBindHelper), &Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_bHasSubSequence_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_bHasSubSequence_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_bHasSubSequence_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_SubSeq = { "SubSeq", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKeyToTimeBindHelper, SubSeq), Z_Construct_UScriptStruct_FSubSequence, METADATA_PARAMS(Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_SubSeq_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_SubSeq_MetaData)) }; // 3456122606
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_Key = { "Key", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKeyToTimeBindHelper, Key), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_Key_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_Key_MetaData)) }; // 2615338182
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_StartTime = { "StartTime", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKeyToTimeBindHelper, StartTime), METADATA_PARAMS(Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_StartTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_StartTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_TimeWindow = { "TimeWindow", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKeyToTimeBindHelper, TimeWindow), METADATA_PARAMS(Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_TimeWindow_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_TimeWindow_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_bShouldDelayTime = { "bShouldDelayTime", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FKeyToTimeBindHelper), &Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_bShouldDelayTime_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_bShouldDelayTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_bShouldDelayTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_DelayTime = { "DelayTime", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKeyToTimeBindHelper, DelayTime), METADATA_PARAMS(Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_DelayTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_DelayTime_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_bHoldKeysDown = { "bHoldKeysDown", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FKeyToTimeBindHelper), &Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_bHoldKeysDown_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_bHoldKeysDown_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_bHoldKeysDown_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_HoldDownTime = { "HoldDownTime", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKeyToTimeBindHelper, HoldDownTime), METADATA_PARAMS(Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_HoldDownTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewProp_HoldDownTime_MetaData)) };
...
class UScriptStruct* FKeyToTimeBinding::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_KeyToTimeBinding.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FKeyToTimeBinding, Z_Construct_UPackage__Script_QTEPlugin(), TEXT("KeyToTimeBinding"));
	}
	return Z_Registration_Info_UScriptStruct_KeyToTimeBinding.OuterSingleton;
}
template<> QTEPLUGIN_API UScriptStruct* StaticStruct<FKeyToTimeBinding>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FKeyToTimeBinding_Statics::NewProp_bTimed = { "bTimed", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FKeyToTimeBinding), &Z_Construct_UScriptStruct_FKeyToTimeBinding_Statics::NewProp_bTimed_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FKeyToTimeBinding_Statics::NewProp_bTimed_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKeyToTimeBinding_Statics::NewProp_bTimed_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FKeyToTimeBinding_Statics::NewProp_KeyTimeBind_Inner = { "KeyTimeBind", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FKeyToTimeBindHelper, METADATA_PARAMS(nullptr, 0) }; // 3382792859
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FKeyToTimeBinding_Statics::NewProp_KeyTimeBind = { "KeyTimeBind", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKeyToTimeBinding, KeyTimeBind), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FKeyToTimeBinding_Statics::NewProp_KeyTimeBind_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKeyToTimeBinding_Statics::NewProp_KeyTimeBind_MetaData)) }; // 3382792859
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FKeyToTimeBinding_Statics::NewProp_KeyCombos_Inner = { "KeyCombos", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FKey, METADATA_PARAMS(nullptr, 0) }; // 2615338182
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FKeyToTimeBinding_Statics::NewProp_KeyCombos = { "KeyCombos", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKeyToTimeBinding, KeyCombos), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FKeyToTimeBinding_Statics::NewProp_KeyCombos_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKeyToTimeBinding_Statics::NewProp_KeyCombos_MetaData)) }; // 2615338182
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FKeyToTimeBinding_Statics::NewProp_bHoldKeysDown = { "bHoldKeysDown", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FKeyToTimeBinding), &Z_Construct_UScriptStruct_FKeyToTimeBinding_Statics::NewProp_bHoldKeysDown_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FKeyToTimeBinding_Statics::NewProp_bHoldKeysDown_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKeyToTimeBinding_Statics::NewProp_bHoldKeysDown_MetaData)) };
...
class UScriptStruct* FKeyInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_KeyInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FKeyInfo, Z_Construct_UPackage__Script_QTEPlugin(), TEXT("KeyInfo"));
	}
	return Z_Registration_Info_UScriptStruct_KeyInfo.OuterSingleton;
}
template<> QTEPLUGIN_API UScriptStruct* StaticStruct<FKeyInfo>()
{
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bInsantFailure_MetaData[];
#endif
		static void NewProp_bInsantFailure_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bInsantFailure;
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_bHasSequence = { "bHasSequence", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FKeyInfo), &Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_bHasSequence_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_bHasSequence_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_bHasSequence_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_bCanRegress = { "bCanRegress", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FKeyInfo), &Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_bCanRegress_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_bCanRegress_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_bCanRegress_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_RegressDistance = { "RegressDistance", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKeyInfo, RegressDistance), METADATA_PARAMS(Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_RegressDistance_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_RegressDistance_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_AttemptsToRegress = { "AttemptsToRegress", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKeyInfo, AttemptsToRegress), METADATA_PARAMS(Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_AttemptsToRegress_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_AttemptsToRegress_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_SuccessDistance = { "SuccessDistance", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKeyInfo, SuccessDistance), METADATA_PARAMS(Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_SuccessDistance_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_SuccessDistance_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_bInsantFailure_MetaData[] = {
		{ "Category", "Sequence Data" },
		{ "ModuleRelativePath", "Public/UQTEUtilities.h" },
		{ "ToolTip", "Should the sequence fail if the wrong key is pressed" },
	};
#endif
	void Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_bInsantFailure_SetBit(void* Obj)
	{
		((FKeyInfo*)Obj)->bInsantFailure = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_bInsantFailure = { "bInsantFailure", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FKeyInfo), &Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_bInsantFailure_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_bInsantFailure_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_bInsantFailure_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_MaxAttemptsToFail = { "MaxAttemptsToFail", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKeyInfo, MaxAttemptsToFail), METADATA_PARAMS(Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_MaxAttemptsToFail_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_MaxAttemptsToFail_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_KeySequence = { "KeySequence", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKeyInfo, KeySequence), Z_Construct_UScriptStruct_FKeyToTimeBinding, METADATA_PARAMS(Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_KeySequence_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_KeySequence_MetaData)) }; // 232497748
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_KeyToPress = { "KeyToPress", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKeyInfo, KeyToPress), Z_Construct_UScriptStruct_FKey, METADATA_PARAMS(Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_KeyToPress_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_KeyToPress_MetaData)) }; // 2615338182
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_bHoldKeyDown = { "bHoldKeyDown", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FKeyInfo), &Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_bHoldKeyDown_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_bHoldKeyDown_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_bHoldKeyDown_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FKeyInfo_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FKeyInfo_Statics::NewProp_bInsantFailure,
...
class UScriptStruct* FInputStruct::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_InputStruct.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FInputStruct, Z_Construct_UPackage__Script_QTEPlugin(), TEXT("InputStruct"));
	}
	return Z_Registration_Info_UScriptStruct_InputStruct.OuterSingleton;
}
template<> QTEPLUGIN_API UScriptStruct* StaticStruct<FInputStruct>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FInputStruct_Statics::NewProp_KeyData = { "KeyData", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FInputStruct, KeyData), Z_Construct_UScriptStruct_FKeyInfo, METADATA_PARAMS(Z_Construct_UScriptStruct_FInputStruct_Statics::NewProp_KeyData_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInputStruct_Statics::NewProp_KeyData_MetaData)) }; // 2336945135
...
class UScriptStruct* FInputData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_InputData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FInputData, Z_Construct_UPackage__Script_QTEPlugin(), TEXT("InputData"));
	}
	return Z_Registration_Info_UScriptStruct_InputData.OuterSingleton;
}
template<> QTEPLUGIN_API UScriptStruct* StaticStruct<FInputData>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bValidInput = { "bValidInput", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FInputData), &Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bValidInput_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bValidInput_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bValidInput_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bCanRegress = { "bCanRegress", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FInputData), &Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bCanRegress_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bCanRegress_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bCanRegress_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FInputData_Statics::NewProp_NoInputTimeDelay = { "NoInputTimeDelay", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FInputData, NoInputTimeDelay), METADATA_PARAMS(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_NoInputTimeDelay_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_NoInputTimeDelay_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FInputData_Statics::NewProp_RegressDistance = { "RegressDistance", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FInputData, RegressDistance), METADATA_PARAMS(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_RegressDistance_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_RegressDistance_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FInputData_Statics::NewProp_AttemptsToRegress = { "AttemptsToRegress", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FInputData, AttemptsToRegress), METADATA_PARAMS(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_AttemptsToRegress_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_AttemptsToRegress_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FInputData_Statics::NewProp_SuccessDistance = { "SuccessDistance", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FInputData, SuccessDistance), METADATA_PARAMS(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_SuccessDistance_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_SuccessDistance_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bInsantFailure_MetaData[] = {
		{ "Category", "Sequence data Copy" },
		{ "ModuleRelativePath", "Public/UQTEUtilities.h" },
		{ "ToolTip", "Should the sequence fail if the wrong key is pressed" },
	};
#endif
	void Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bInsantFailure_SetBit(void* Obj)
	{
		((FInputData*)Obj)->bInsantFailure = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bInsantFailure = { "bInsantFailure", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FInputData), &Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bInsantFailure_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bInsantFailure_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bInsantFailure_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FInputData_Statics::NewProp_MaxAttemptsToFail = { "MaxAttemptsToFail", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FInputData, MaxAttemptsToFail), METADATA_PARAMS(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_MaxAttemptsToFail_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_MaxAttemptsToFail_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bHasOpeningSequence = { "bHasOpeningSequence", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FInputData), &Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bHasOpeningSequence_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bHasOpeningSequence_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bHasOpeningSequence_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bHasSequence = { "bHasSequence", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FInputData), &Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bHasSequence_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bHasSequence_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bHasSequence_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bTimed = { "bTimed", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FInputData), &Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bTimed_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bTimed_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bTimed_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FInputData_Statics::NewProp_KeyToTimeBinder_Inner = { "KeyToTimeBinder", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FKeyToTimeBindHelper, METADATA_PARAMS(nullptr, 0) }; // 3382792859
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FInputData_Statics::NewProp_KeyToTimeBinder = { "KeyToTimeBinder", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FInputData, KeyToTimeBinder), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_KeyToTimeBinder_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_KeyToTimeBinder_MetaData)) }; // 3382792859
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FInputData_Statics::NewProp_Keys_Inner = { "Keys", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FKey, METADATA_PARAMS(nullptr, 0) }; // 2615338182
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FInputData_Statics::NewProp_Keys = { "Keys", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FInputData, Keys), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_Keys_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_Keys_MetaData)) }; // 2615338182
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bHoldDownKeys = { "bHoldDownKeys", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FInputData), &Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bHoldDownKeys_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bHoldDownKeys_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bHoldDownKeys_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FInputData_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FInputData_Statics::NewProp_bInsantFailure,
	...
	static UEnum* QTEConditionalInput_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_QTEConditionalInput.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_QTEPlugin_QTEConditionalInput, Z_Construct_UPackage__Script_QTEPlugin(), TEXT("QTEConditionalInput"));
		}
		return Z_Registration_Info_UEnum_QTEConditionalInput.OuterSingleton;
	}
	template<> QTEPLUGIN_API UEnum* StaticEnum<QTEConditionalInput>()
	{
		return QTEConditionalInput_StaticEnum();
	}
	struct Z_Construct_UEnum_QTEPlugin_QTEConditionalInput_Statics
	{
		static const UECodeGen_Private::FEnumeratorParam Enumerators[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[];
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_QTEPlugin_QTEConditionalInput_Statics::Enumerators[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_QTEPlugin_QTEConditionalInput_Statics::Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_QTEPlugin_QTEConditionalInput_Statics::EnumParams = {
		(UObject*(*)())Z_Construct_UPackage__Script_QTEPlugin,
		nullptr,
		"QTEConditionalInput",
		"QTEConditionalInput",
		Z_Construct_UEnum_QTEPlugin_QTEConditionalInput_Statics::Enumerators,
		UE_ARRAY_COUNT(Z_Construct_UEnum_QTEPlugin_QTEConditionalInput_Statics::Enumerators),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_QTEPlugin_QTEConditionalInput_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_QTEPlugin_QTEConditionalInput_Statics::Enum_MetaDataParams))
	};
	UEnum* Z_Construct_UEnum_QTEPlugin_QTEConditionalInput()
	{
		if (!Z_Registration_Info_UEnum_QTEConditionalInput.InnerSingleton)
		{
			UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_QTEConditionalInput.InnerSingleton, Z_Construct_UEnum_QTEPlugin_QTEConditionalInput_Statics::EnumParams);
		}
...
class UScriptStruct* FConditionalQTEHelperData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ConditionalQTEHelperData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FConditionalQTEHelperData, Z_Construct_UPackage__Script_QTEPlugin(), TEXT("ConditionalQTEHelperData"));
	}
	return Z_Registration_Info_UScriptStruct_ConditionalQTEHelperData.OuterSingleton;
}
template<> QTEPLUGIN_API UScriptStruct* StaticStruct<FConditionalQTEHelperData>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FConditionalQTEHelperData_Statics::NewProp_Threshold = { "Threshold", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConditionalQTEHelperData, Threshold), METADATA_PARAMS(Z_Construct_UScriptStruct_FConditionalQTEHelperData_Statics::NewProp_Threshold_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConditionalQTEHelperData_Statics::NewProp_Threshold_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FConditionalQTEHelperData_Statics::NewProp_Keys = { "Keys", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConditionalQTEHelperData, Keys), Z_Construct_UScriptStruct_FSubSequenceHelper, METADATA_PARAMS(Z_Construct_UScriptStruct_FConditionalQTEHelperData_Statics::NewProp_Keys_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConditionalQTEHelperData_Statics::NewProp_Keys_MetaData)) }; // 3043625189
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FConditionalQTEHelperData_Statics::NewProp_PreciseKeys_Inner = { "PreciseKeys", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FPrecisionKeys, METADATA_PARAMS(nullptr, 0) }; // 4206374372
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FConditionalQTEHelperData_Statics::NewProp_PreciseKeys = { "PreciseKeys", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConditionalQTEHelperData, PreciseKeys), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FConditionalQTEHelperData_Statics::NewProp_PreciseKeys_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConditionalQTEHelperData_Statics::NewProp_PreciseKeys_MetaData)) }; // 4206374372
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FConditionalQTEHelperData_Statics::NewProp_subSeq = { "subSeq", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConditionalQTEHelperData, subSeq), Z_Construct_UScriptStruct_FSubSequence, METADATA_PARAMS(Z_Construct_UScriptStruct_FConditionalQTEHelperData_Statics::NewProp_subSeq_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConditionalQTEHelperData_Statics::NewProp_subSeq_MetaData)) }; // 3456122606
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FConditionalQTEHelperData_Statics::NewProp_InputChoice_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FConditionalQTEHelperData_Statics::NewProp_InputChoice = { "InputChoice", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConditionalQTEHelperData, InputChoice), Z_Construct_UEnum_QTEPlugin_QTEConditionalInput, METADATA_PARAMS(Z_Construct_UScriptStruct_FConditionalQTEHelperData_Statics::NewProp_InputChoice_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConditionalQTEHelperData_Statics::NewProp_InputChoice_MetaData)) }; // 758030739
...
class UScriptStruct* FConditionalQTEHelper::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ConditionalQTEHelper.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FConditionalQTEHelper, Z_Construct_UPackage__Script_QTEPlugin(), TEXT("ConditionalQTEHelper"));
	}
	return Z_Registration_Info_UScriptStruct_ConditionalQTEHelper.OuterSingleton;
}
template<> QTEPLUGIN_API UScriptStruct* StaticStruct<FConditionalQTEHelper>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FConditionalQTEHelper_Statics::NewProp_Data_Inner = { "Data", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FConditionalQTEHelperData, METADATA_PARAMS(nullptr, 0) }; // 460632566
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FConditionalQTEHelper_Statics::NewProp_Data = { "Data", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConditionalQTEHelper, Data), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FConditionalQTEHelper_Statics::NewProp_Data_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConditionalQTEHelper_Statics::NewProp_Data_MetaData)) }; // 460632566
...
class UScriptStruct* FResultSequenceBinding::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ResultSequenceBinding.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FResultSequenceBinding, Z_Construct_UPackage__Script_QTEPlugin(), TEXT("ResultSequenceBinding"));
	}
	return Z_Registration_Info_UScriptStruct_ResultSequenceBinding.OuterSingleton;
}
template<> QTEPLUGIN_API UScriptStruct* StaticStruct<FResultSequenceBinding>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FResultSequenceBinding_Statics::NewProp_bResult = { "bResult", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FResultSequenceBinding), &Z_Construct_UScriptStruct_FResultSequenceBinding_Statics::NewProp_bResult_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FResultSequenceBinding_Statics::NewProp_bResult_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FResultSequenceBinding_Statics::NewProp_bResult_MetaData)) };
#if WITH_METADATA
...
class UScriptStruct* FConditionalSequencesSupport::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ConditionalSequencesSupport.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FConditionalSequencesSupport, Z_Construct_UPackage__Script_QTEPlugin(), TEXT("ConditionalSequencesSupport"));
	}
	return Z_Registration_Info_UScriptStruct_ConditionalSequencesSupport.OuterSingleton;
}
template<> QTEPLUGIN_API UScriptStruct* StaticStruct<FConditionalSequencesSupport>()
{
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FConditionalSequencesSupport_Statics::NewProp_LevelSequenceRef = { "LevelSequenceRef", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConditionalSequencesSupport, LevelSequenceRef), Z_Construct_UClass_ULevelSequence_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FConditionalSequencesSupport_Statics::NewProp_LevelSequenceRef_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConditionalSequencesSupport_Statics::NewProp_LevelSequenceRef_MetaData)) };
#if WITH_METADATA
...
class UScriptStruct* FConditionalSequences::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ConditionalSequences.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FConditionalSequences, Z_Construct_UPackage__Script_QTEPlugin(), TEXT("ConditionalSequences"));
	}
	return Z_Registration_Info_UScriptStruct_ConditionalSequences.OuterSingleton;
}
template<> QTEPLUGIN_API UScriptStruct* StaticStruct<FConditionalSequences>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FConditionalSequences_Statics::NewProp_Sequences_ValueProp = { "Sequences", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, Z_Construct_UScriptStruct_FConditionalSequencesSupport, METADATA_PARAMS(nullptr, 0) }; // 1123229615
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FConditionalSequences_Statics::NewProp_Sequences_Key_KeyProp = { "Sequences_Key", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UScriptStruct_FConditionalSequences_Statics::NewProp_Sequences = { "Sequences", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConditionalSequences, Sequences), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FConditionalSequences_Statics::NewProp_Sequences_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConditionalSequences_Statics::NewProp_Sequences_MetaData)) }; // 1123229615
...
class UScriptStruct* FConditionalQTE::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ConditionalQTE.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FConditionalQTE, Z_Construct_UPackage__Script_QTEPlugin(), TEXT("ConditionalQTE"));
	}
	return Z_Registration_Info_UScriptStruct_ConditionalQTE.OuterSingleton;
}
template<> QTEPLUGIN_API UScriptStruct* StaticStruct<FConditionalQTE>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_bInstantFailure = { "bInstantFailure", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FConditionalQTE), &Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_bInstantFailure_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_bInstantFailure_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_bInstantFailure_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_FailureLimit = { "FailureLimit", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConditionalQTE, FailureLimit), METADATA_PARAMS(Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_FailureLimit_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_FailureLimit_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_SuccessLimit = { "SuccessLimit", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConditionalQTE, SuccessLimit), METADATA_PARAMS(Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_SuccessLimit_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_SuccessLimit_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_FailRatio = { "FailRatio", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConditionalQTE, FailRatio), METADATA_PARAMS(Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_FailRatio_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_FailRatio_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_SuccessRatio = { "SuccessRatio", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConditionalQTE, SuccessRatio), METADATA_PARAMS(Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_SuccessRatio_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_SuccessRatio_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_bPlayHelperSequences = { "bPlayHelperSequences", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FConditionalQTE), &Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_bPlayHelperSequences_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_bPlayHelperSequences_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_bPlayHelperSequences_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_SuccessThreshold = { "SuccessThreshold", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConditionalQTE, SuccessThreshold), METADATA_PARAMS(Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_SuccessThreshold_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_SuccessThreshold_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_FailThreshold = { "FailThreshold", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConditionalQTE, FailThreshold), METADATA_PARAMS(Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_FailThreshold_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_FailThreshold_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_FailInput = { "FailInput", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConditionalQTE, FailInput), Z_Construct_UScriptStruct_FConditionalSequences, METADATA_PARAMS(Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_FailInput_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_FailInput_MetaData)) }; // 710338421
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_SuccessInput = { "SuccessInput", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConditionalQTE, SuccessInput), Z_Construct_UScriptStruct_FConditionalSequences, METADATA_PARAMS(Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_SuccessInput_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_SuccessInput_MetaData)) }; // 710338421
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_bHasOpeningSequence = { "bHasOpeningSequence", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FConditionalQTE), &Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_bHasOpeningSequence_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_bHasOpeningSequence_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewProp_bHasOpeningSequence_MetaData)) };
...
class UScriptStruct* FSequenceNode::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SequenceNode.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSequenceNode, Z_Construct_UPackage__Script_QTEPlugin(), TEXT("SequenceNode"));
	}
	return Z_Registration_Info_UScriptStruct_SequenceNode.OuterSingleton;
}
template<> QTEPLUGIN_API UScriptStruct* StaticStruct<FSequenceNode>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_SequenceName = { "SequenceName", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSequenceNode, SequenceName), METADATA_PARAMS(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_SequenceName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_SequenceName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_SceneRate = { "SceneRate", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSequenceNode, SceneRate), METADATA_PARAMS(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_SceneRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_SceneRate_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bDynamicScenes = { "bDynamicScenes", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FSequenceNode), &Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bDynamicScenes_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bDynamicScenes_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bDynamicScenes_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bIsConditionalQTE = { "bIsConditionalQTE", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FSequenceNode), &Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bIsConditionalQTE_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bIsConditionalQTE_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bIsConditionalQTE_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_conditionalQTE = { "conditionalQTE", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSequenceNode, conditionalQTE), Z_Construct_UScriptStruct_FConditionalQTE, METADATA_PARAMS(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_conditionalQTE_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_conditionalQTE_MetaData)) }; // 3924526589
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_OpeningSeq = { "OpeningSeq", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSequenceNode, OpeningSeq), Z_Construct_UClass_ULevelSequence_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_OpeningSeq_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_OpeningSeq_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_CurrentSeq = { "CurrentSeq", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSequenceNode, CurrentSeq), Z_Construct_UClass_ULevelSequence_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_CurrentSeq_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_CurrentSeq_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_FailName = { "FailName", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSequenceNode, FailName), METADATA_PARAMS(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_FailName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_FailName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_SuccessName = { "SuccessName", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSequenceNode, SuccessName), METADATA_PARAMS(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_SuccessName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_SuccessName_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bCinematicOnly = { "bCinematicOnly", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FSequenceNode), &Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bCinematicOnly_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bCinematicOnly_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bCinematicOnly_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bExecution = { "bExecution", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FSequenceNode), &Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bExecution_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bExecution_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bExecution_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_DestroyTime = { "DestroyTime", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSequenceNode, DestroyTime), METADATA_PARAMS(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_DestroyTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_DestroyTime_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bAll = { "bAll", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FSequenceNode), &Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bAll_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bAll_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bAll_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bOwner = { "bOwner", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FSequenceNode), &Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bOwner_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bOwner_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bOwner_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bAllExeceptOwner = { "bAllExeceptOwner", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FSequenceNode), &Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bAllExeceptOwner_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bAllExeceptOwner_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bAllExeceptOwner_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bUseIndex = { "bUseIndex", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FSequenceNode), &Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bUseIndex_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bUseIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_bUseIndex_MetaData)) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_ActorToExecute_Inner = { "ActorToExecute", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_ActorToExecute = { "ActorToExecute", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSequenceNode, ActorToExecute), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_ActorToExecute_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_ActorToExecute_MetaData)) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_ActorIndices_Inner = { "ActorIndices", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_ActorIndices = { "ActorIndices", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSequenceNode, ActorIndices), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_ActorIndices_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSequenceNode_Statics::NewProp_ActorIndices_MetaData)) };
#if WITH_METADATA
...
class UScriptStruct* FQTEInputDataTable::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_QTEInputDataTable.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FQTEInputDataTable, Z_Construct_UPackage__Script_QTEPlugin(), TEXT("QTEInputDataTable"));
	}
	return Z_Registration_Info_UScriptStruct_QTEInputDataTable.OuterSingleton;
}
template<> QTEPLUGIN_API UScriptStruct* StaticStruct<FQTEInputDataTable>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FQTEInputDataTable_Statics::NewProp_SeqData = { "SeqData", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FQTEInputDataTable, SeqData), Z_Construct_UScriptStruct_FSequenceNode, METADATA_PARAMS(Z_Construct_UScriptStruct_FQTEInputDataTable_Statics::NewProp_SeqData_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FQTEInputDataTable_Statics::NewProp_SeqData_MetaData)) }; // 2773773965
...
class UScriptStruct* FEntityDataHelper::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_EntityDataHelper.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FEntityDataHelper, Z_Construct_UPackage__Script_QTEPlugin(), TEXT("EntityDataHelper"));
	}
	return Z_Registration_Info_UScriptStruct_EntityDataHelper.OuterSingleton;
}
template<> QTEPLUGIN_API UScriptStruct* StaticStruct<FEntityDataHelper>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FEntityDataHelper_Statics::NewProp_KeyToStart_Inner = { "KeyToStart", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FKey, METADATA_PARAMS(nullptr, 0) }; // 2615338182
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FEntityDataHelper_Statics::NewProp_bIsRepeatable = { "bIsRepeatable", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FEntityDataHelper), &Z_Construct_UScriptStruct_FEntityDataHelper_Statics::NewProp_bIsRepeatable_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FEntityDataHelper_Statics::NewProp_bIsRepeatable_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEntityDataHelper_Statics::NewProp_bIsRepeatable_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FEntityDataHelper_Statics::NewProp_Runs = { "Runs", nullptr, (EPropertyFlags)0x0010000000020005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FEntityDataHelper, Runs), METADATA_PARAMS(Z_Construct_UScriptStruct_FEntityDataHelper_Statics::NewProp_Runs_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEntityDataHelper_Statics::NewProp_Runs_MetaData)) };
...
class UScriptStruct* FQTEEntitySettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_QTEEntitySettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FQTEEntitySettings, Z_Construct_UPackage__Script_QTEPlugin(), TEXT("QTEEntitySettings"));
	}
	return Z_Registration_Info_UScriptStruct_QTEEntitySettings.OuterSingleton;
}
template<> QTEPLUGIN_API UScriptStruct* StaticStruct<FQTEEntitySettings>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FQTEEntitySettings_Statics::NewProp_EntityData_ValueProp = { "EntityData", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, Z_Construct_UScriptStruct_FEntityDataHelper, METADATA_PARAMS(nullptr, 0) }; // 3539556550
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FQTEEntitySettings_Statics::NewProp_EntityData_Key_KeyProp = { "EntityData_Key", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UDataTable_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UScriptStruct_FQTEEntitySettings_Statics::NewProp_EntityData = { "EntityData", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FQTEEntitySettings, EntityData), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FQTEEntitySettings_Statics::NewProp_EntityData_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FQTEEntitySettings_Statics::NewProp_EntityData_MetaData)) }; // 3539556550
...
class UScriptStruct* FTimeSequenceHelper::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_TimeSequenceHelper.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTimeSequenceHelper, Z_Construct_UPackage__Script_QTEPlugin(), TEXT("TimeSequenceHelper"));
	}
	return Z_Registration_Info_UScriptStruct_TimeSequenceHelper.OuterSingleton;
}
template<> QTEPLUGIN_API UScriptStruct* StaticStruct<FTimeSequenceHelper>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTimeSequenceHelper_Statics::NewProp_StartTimeCopy = { "StartTimeCopy", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTimeSequenceHelper, StartTimeCopy), METADATA_PARAMS(Z_Construct_UScriptStruct_FTimeSequenceHelper_Statics::NewProp_StartTimeCopy_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTimeSequenceHelper_Statics::NewProp_StartTimeCopy_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTimeSequenceHelper_Statics::NewProp_TimeDelayCopy = { "TimeDelayCopy", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTimeSequenceHelper, TimeDelayCopy), METADATA_PARAMS(Z_Construct_UScriptStruct_FTimeSequenceHelper_Statics::NewProp_TimeDelayCopy_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTimeSequenceHelper_Statics::NewProp_TimeDelayCopy_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTimeSequenceHelper_Statics::NewProp_HoldDownKeyTimeCopy = { "HoldDownKeyTimeCopy", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTimeSequenceHelper, HoldDownKeyTimeCopy), METADATA_PARAMS(Z_Construct_UScriptStruct_FTimeSequenceHelper_Statics::NewProp_HoldDownKeyTimeCopy_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTimeSequenceHelper_Statics::NewProp_HoldDownKeyTimeCopy_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_QTEPlugin_Source_QTEPlugin_Public_UQTEUtilities_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_QTEPlugin_Source_QTEPlugin_Public_UQTEUtilities_h_Statics::EnumInfo[] = {
		{ KeyResultData_StaticEnum, TEXT("KeyResultData"), &Z_Registration_Info_UEnum_KeyResultData, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2952770604U) },
		{ QTEInputPath_StaticEnum, TEXT("QTEInputPath"), &Z_Registration_Info_UEnum_QTEInputPath, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 928388350U) },
		{ QTEConditionalInput_StaticEnum, TEXT("QTEConditionalInput"), &Z_Registration_Info_UEnum_QTEConditionalInput, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 758030739U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_QTEPlugin_Source_QTEPlugin_Public_UQTEUtilities_h_Statics::ScriptStructInfo[] = {
		{ FSubSequenceHelper::StaticStruct, Z_Construct_UScriptStruct_FSubSequenceHelper_Statics::NewStructOps, TEXT("SubSequenceHelper"), &Z_Registration_Info_UScriptStruct_SubSequenceHelper, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSubSequenceHelper), 3043625189U) },
		{ FSubSequence::StaticStruct, Z_Construct_UScriptStruct_FSubSequence_Statics::NewStructOps, TEXT("SubSequence"), &Z_Registration_Info_UScriptStruct_SubSequence, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSubSequence), 3456122606U) },
		{ FPrecisionKeys::StaticStruct, Z_Construct_UScriptStruct_FPrecisionKeys_Statics::NewStructOps, TEXT("PrecisionKeys"), &Z_Registration_Info_UScriptStruct_PrecisionKeys, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPrecisionKeys), 4206374372U) },
		{ FKeyToTimeBindHelper::StaticStruct, Z_Construct_UScriptStruct_FKeyToTimeBindHelper_Statics::NewStructOps, TEXT("KeyToTimeBindHelper"), &Z_Registration_Info_UScriptStruct_KeyToTimeBindHelper, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FKeyToTimeBindHelper), 3382792859U) },
		{ FKeyToTimeBinding::StaticStruct, Z_Construct_UScriptStruct_FKeyToTimeBinding_Statics::NewStructOps, TEXT("KeyToTimeBinding"), &Z_Registration_Info_UScriptStruct_KeyToTimeBinding, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FKeyToTimeBinding), 232497748U) },
		{ FKeyInfo::StaticStruct, Z_Construct_UScriptStruct_FKeyInfo_Statics::NewStructOps, TEXT("KeyInfo"), &Z_Registration_Info_UScriptStruct_KeyInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FKeyInfo), 2336945135U) },
		{ FInputStruct::StaticStruct, Z_Construct_UScriptStruct_FInputStruct_Statics::NewStructOps, TEXT("InputStruct"), &Z_Registration_Info_UScriptStruct_InputStruct, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FInputStruct), 2165798266U) },
		{ FInputData::StaticStruct, Z_Construct_UScriptStruct_FInputData_Statics::NewStructOps, TEXT("InputData"), &Z_Registration_Info_UScriptStruct_InputData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FInputData), 2721462969U) },
		{ FConditionalQTEHelperData::StaticStruct, Z_Construct_UScriptStruct_FConditionalQTEHelperData_Statics::NewStructOps, TEXT("ConditionalQTEHelperData"), &Z_Registration_Info_UScriptStruct_ConditionalQTEHelperData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FConditionalQTEHelperData), 460632566U) },
		{ FConditionalQTEHelper::StaticStruct, Z_Construct_UScriptStruct_FConditionalQTEHelper_Statics::NewStructOps, TEXT("ConditionalQTEHelper"), &Z_Registration_Info_UScriptStruct_ConditionalQTEHelper, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FConditionalQTEHelper), 2585926195U) },
		{ FResultSequenceBinding::StaticStruct, Z_Construct_UScriptStruct_FResultSequenceBinding_Statics::NewStructOps, TEXT("ResultSequenceBinding"), &Z_Registration_Info_UScriptStruct_ResultSequenceBinding, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FResultSequenceBinding), 3709112818U) },
		{ FConditionalSequencesSupport::StaticStruct, Z_Construct_UScriptStruct_FConditionalSequencesSupport_Statics::NewStructOps, TEXT("ConditionalSequencesSupport"), &Z_Registration_Info_UScriptStruct_ConditionalSequencesSupport, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FConditionalSequencesSupport), 1123229615U) },
		{ FConditionalSequences::StaticStruct, Z_Construct_UScriptStruct_FConditionalSequences_Statics::NewStructOps, TEXT("ConditionalSequences"), &Z_Registration_Info_UScriptStruct_ConditionalSequences, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FConditionalSequences), 710338421U) },
		{ FConditionalQTE::StaticStruct, Z_Construct_UScriptStruct_FConditionalQTE_Statics::NewStructOps, TEXT("ConditionalQTE"), &Z_Registration_Info_UScriptStruct_ConditionalQTE, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FConditionalQTE), 3924526589U) },
		{ FSequenceNode::StaticStruct, Z_Construct_UScriptStruct_FSequenceNode_Statics::NewStructOps, TEXT("SequenceNode"), &Z_Registration_Info_UScriptStruct_SequenceNode, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSequenceNode), 2773773965U) },
		{ FQTEInputDataTable::StaticStruct, Z_Construct_UScriptStruct_FQTEInputDataTable_Statics::NewStructOps, TEXT("QTEInputDataTable"), &Z_Registration_Info_UScriptStruct_QTEInputDataTable, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FQTEInputDataTable), 825653006U) },
		{ FEntityDataHelper::StaticStruct, Z_Construct_UScriptStruct_FEntityDataHelper_Statics::NewStructOps, TEXT("EntityDataHelper"), &Z_Registration_Info_UScriptStruct_EntityDataHelper, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FEntityDataHelper), 3539556550U) },
		{ FQTEEntitySettings::StaticStruct, Z_Construct_UScriptStruct_FQTEEntitySettings_Statics::NewStructOps, TEXT("QTEEntitySettings"), &Z_Registration_Info_UScriptStruct_QTEEntitySettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FQTEEntitySettings), 731667939U) },
		{ FTimeSequenceHelper::StaticStruct, Z_Construct_UScriptStruct_FTimeSequenceHelper_Statics::NewStructOps, TEXT("TimeSequenceHelper"), &Z_Registration_Info_UScriptStruct_TimeSequenceHelper, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTimeSequenceHelper), 624265039U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_QTEPlugin_Source_QTEPlugin_Public_UQTEUtilities_h_1504614035(TEXT("/Script/QTEPlugin"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_HostProject_Plugins_QTEPlugin_Source_QTEPlugin_Public_UQTEUtilities_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_QTEPlugin_Source_QTEPlugin_Public_UQTEUtilities_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_QTEPlugin_Source_QTEPlugin_Public_UQTEUtilities_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_QTEPlugin_Source_QTEPlugin_Public_UQTEUtilities_h_Statics::EnumInfo));
